...
const { addToCart } = useContext(CartContext);
  ...
  return (
    <>
      {/* PRODUCT TOP SECTION */}
      <div className="min-h-screen bg-[#121212] text-white px-10 py-10 pt-25 grid grid-cols-1 md:grid-cols-2 gap-12">
        {/* LEFT IMAGES */}  
        ...
        <div>
          ...
          <div className="mb-4 mt-4">
            ...
            <div className="text-[#A9AFC3] mt-5 flex gap-4">
              <button className="border border-amber-50 px-5 py-2 rounded-[5px]">
 ...
 onClick={() => addToCart(product)}
  className="mt-6 bg-red-600 hover:bg-red-700 px-10 py-3 rounded-lg text-lg"
>
  Add to Cart
</button>
        </div>
      ...
      <div className="bg-black w-full py-20">
        ...
        <div className="flex justify-center gap-10 text-lg">
          {["specifications", "overview", "reviews"].map((tab) => (
            <button
              ...
              className={`px-6 py-2 rounded-md transition-all duration-300 cursor-pointer
          ${
            activeTab === tab
        ...
        {/* CONTENT */}
        <div className="mt-10 bg-[#0f0f0f] rounded-xl p-10 max-w-5xl mx-auto shadow-lg">
          {activeTab === "specifications" && (
            <div className="flex gap-20 text-lg text-gray-300 justify-center">
              <ul>
              ...
              <ul className="font-semibold text-right text-white">
          ...
          {activeTab === "reviews" && (
            <div className="bg-[#121212] rounded-lg p-6 flex gap-4 max-w-xl">
      ...
      {/* ================= RELATED PRODUCTS ================= */}
<div className="bg-[#121212] px-10 py-20">
